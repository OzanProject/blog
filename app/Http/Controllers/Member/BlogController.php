...
class BlogController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'thumbnail.mimes' => 'Ekstensi yang diperbolehkan hanya jpeg, png, jpg, gif, svg',
            'thumbnail.max' => 'Ukuran maksimum thumbnail tidak boleh melebihi 10MB',
        ]);
    ...
    public function update(Request $request, Post $post)
    {
        ...
        return redirect()->route('member.blogs.index')->with('success','Data berhasil diubah');
    }
